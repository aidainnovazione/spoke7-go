...
func main() {
	...
	logger.Info("Starting Metadata Server")
	...
	metadataServer := metadata.NewMetadataServer(e, repo, grpcStorageString, Version, logger, config.AppConfig.Authentication.OrganizationName)
