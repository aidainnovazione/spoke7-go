...
const (
	HealthService_GetHealthStatus_FullMethodName = "/pb.HealthService/GetHealthStatus"
)
...
type HealthServiceClient interface {
	GetHealthStatus(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Health, error)
}
...
func (c *healthServiceClient) GetHealthStatus(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Health, error) {
...
type HealthServiceServer interface {
	GetHealthStatus(context.Context, *emptypb.Empty) (*Health, error)
...
func (UnimplementedHealthServiceServer) GetHealthStatus(context.Context, *emptypb.Empty) (*Health, error) {
...
var HealthService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "services/health.service.proto",
}
