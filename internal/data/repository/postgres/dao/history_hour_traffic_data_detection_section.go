...
type HistoryHourTrafficDataByDetectionSectionDao struct {
...
func (HistoryHourTrafficDataByDetectionSectionDao) TableName() string {
	return "history_hour_traffic_data_by_detection_section"
}

func (c HistoryHourTrafficDataByDetectionSectionDao) FromHistoryHourTrafficDataByDetectionSectionDaoToModel() models.HistoryTrafficDataByDetectionSectionModel {
...
func FromHistoryHourTrafficDataByDetectionSectionModelToDao(traffic models.HistoryTrafficDataByDetectionSectionModel) HistoryHourTrafficDataByDetectionSectionDao {
	return HistoryHourTrafficDataByDetectionSectionDao{
