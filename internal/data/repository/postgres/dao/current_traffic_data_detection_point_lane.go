...
type CurrentTrafficDataByDetectionPointByLaneDao struct {
	...
	CountVehicleClassAll uint32    `gorm:"type:integer;not null"`
...
func (CurrentTrafficDataByDetectionPointByLaneDao) TableName() string {
	return "current_traffic_data_by_detection_point_by_lane"
}

func (c CurrentTrafficDataByDetectionPointByLaneDao) FromCurrentTrafficDataByDetectionPointByLaneDaoToModel() models.CurrentTrafficDataByDetectionPointByLaneModel {
	return models.CurrentTrafficDataByDetectionPointByLaneModel{
		...
		CountVehicleClassAll:                   c.CountVehicleClassAll,
...
func FromCurrentTrafficDataByDetectionPointByLaneModelToDao(traffic models.CurrentTrafficDataByDetectionPointByLaneModel) CurrentTrafficDataByDetectionPointByLaneDao {
	return CurrentTrafficDataByDetectionPointByLaneDao{
