...
func FromHistoryDayTrafficDataByDetectionPointModelsToProtos(trafficList []models.HistoryDayTrafficDataByDetectionPointModel) ([]*pb.HistoryDayTrafficDataByDetectionPoint, error) {
	protoTraffic := make([]*pb.HistoryDayTrafficDataByDetectionPoint, len(trafficList))
	for i, traffic := range trafficList {
		protoTrafficList, err := FromHistoryDayTrafficDataByDetectionPointModelToProto(&traffic)
		if err != nil {
			return nil, err
		}
...
func FromHistoryDayTrafficDataByDetectionPointModelToProto(traffic *models.HistoryDayTrafficDataByDetectionPointModel) (*pb.HistoryDayTrafficDataByDetectionPoint, error) {
	protoTraffic := &pb.HistoryDayTrafficDataByDetectionPoint{
...
func FromHistoryDayTrafficDataByDetectionPointProtosToModels(trafficList []*pb.HistoryDayTrafficDataByDetectionPoint) ([]*models.HistoryDayTrafficDataByDetectionPointModel, error) {
	protoTraffic := make([]*models.HistoryDayTrafficDataByDetectionPointModel, len(trafficList))
	for i, traffic := range trafficList {
		protoTrafficList, err := FromHistoryDayTrafficDataByDetectionPointProtoToModel(traffic)
		if err != nil {
			return nil, err
		}
		protoTraffic[i] = protoTrafficList
...
func FromHistoryDayTrafficDataByDetectionPointProtoToModel(traffic *pb.HistoryDayTrafficDataByDetectionPoint) (*models.HistoryDayTrafficDataByDetectionPointModel, error) {
	modelTraffic := models.HistoryDayTrafficDataByDetectionPointModel{
